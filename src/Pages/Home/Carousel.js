...
const Carousel = () => {
    return (
        <section>
            <h1 className='text-purple-500 text-center mt-20 mb-10 text-3xl font-bold '>Our products for sell</h1>
            <div class="carousel shadow-xl carousel-center max-w p-4 space-x-4 bg-purple-200 rounded-box mx-auto mb-20 sm:p-5">
